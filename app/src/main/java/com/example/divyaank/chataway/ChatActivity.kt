...
import com.example.divyaank.chataway.model.MessageType
import com.example.divyaank.chataway.model.TextMessage
import com.example.divyaank.chataway.model.User
...
class ChatActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        FirestoreUtil.getOrCreateChatChannel(otherUserId){
            ...
            messagesListenerRegistration = FirestoreUtil
                .addChatMessageListener(channelId, this, this::updateRecyclerView)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        if (requestCode == RC_SELECT_IMAGE && resultCode == Activity.RESULT_OK &&
            ...
            StorageUtil.uploadMessageImage(selectedImageBytes){
                imagePath -> val  messageToSend = ImageMessage(imagePath, Calendar.getInstance().time,
                    FirebaseAuth.getInstance().currentUser!!.uid, otherUserId,
                    currentUser.name)
